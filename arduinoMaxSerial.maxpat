...
,
		"rect" : [ 75.0, 116.0, 756.0, 320.0 ],
		"bgcolor" : [ 0.339555, 0.60307, 0.35191, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 853.0, 239.0, 167.0, 20.0 ],
					"text" : "Set Default to \"from Max 1\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.5, 613.0, 150.0, 47.0 ],
					"text" : "Inputs are labled with MIDI notes in order to be Mapped in Ableton Live"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 865.0, 286.0, 56.0, 20.0 ],
					"text" : "delay 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 882.0, 315.0, 32.5, 18.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 934.0, 286.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 934.0, 315.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 934.0, 369.0, 158.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 445.0, 53.0, 127.5, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 934.0, 342.0, 55.0, 21.0 ],
					"text" : "midiinfo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 836.0, 540.0, 56.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 432.0, 162.5, 45.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 836.0, 576.0, 59.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 526.5, 162.5, 59.0, 20.0 ],
					"text" : "ctlout b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 836.0, 508.0, 32.5, 20.0 ],
					"text" : "/ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 836.0, 424.0, 146.0, 20.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 836.0, 465.0, 56.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 645.5, 540.0, 55.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 432.0, 97.0, 45.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 745.0, 540.0, 56.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 432.0, 129.0, 40.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 745.0, 576.0, 59.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 526.5, 129.0, 59.0, 20.0 ],
					"text" : "ctlout a 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 645.5, 576.0, 59.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 526.5, 97.0, 59.0, 20.0 ],
					"text" : "ctlout a 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 745.0, 508.0, 32.5, 20.0 ],
					"text" : "/ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 645.5, 508.0, 32.5, 20.0 ],
					"text" : "/ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 745.0, 424.0, 79.0, 20.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 645.5, 424.0, 80.0, 20.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 645.5, 465.0, 55.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 745.0, 465.0, 56.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 745.0, 57.0, 207.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 326.0, 53.0, 104.0, 20.0 ],
					"text" : "Start and Output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 20.0, 207.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.5, 59.0, 207.0, 20.0 ],
					"text" : "SETUP"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 759.0, 20.0, 248.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.5, 10.0, 248.0, 22.0 ],
					"text" : "BOBDUINO Max Instrument"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 25.5, 117.0, 258.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 585.0, 464.0, 167.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 375.0, 150.0, 98.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 275.0, 125.0, 59.0, 17.0 ],
									"text" : "frgb 0 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 150.0, 152.0, 17.0 ],
...
,
					"patching_rect" : [ 157.0, 540.0, 269.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 475.0, 162.5, 37.0, 21.0 ],
					"text" : "D2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 475.0, 129.0, 37.0, 21.0 ],
					"text" : "A1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 475.0, 97.0, 37.0, 21.0 ],
					"text" : "A0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 72.5, 169.0, 206.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 74.5, 144.0, 227.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 24.5, 169.0, 39.0, 18.0 ],
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 25.5, 144.0, 37.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.5, 89.0, 207.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 25.5, 89.0, 36.0, 18.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 339.5, 131.0, 81.0, 20.0 ],
					"text" : "Click to start"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 326.0, 89.0, 104.0, 104.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 731.25, 275.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.75, 38.5, 293.5, 174.5 ]
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.761787, 1.0, 0.976842, 1.0 ],
					"border" : 6,
					"id" : "obj-24",
					"maxclass" : "panel",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 675.0, 223.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 312.0, 38.5, 285.0, 174.5 ]
				}
